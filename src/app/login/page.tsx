...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen grid place-items-center px-6 bg-gradient-to-b from-white to-pitch-50 dark:from-[#0b1220] dark:to-[#0e1a2e]">
      <div className="w-full max-w-md rounded-xl2 bg-white dark:bg-ink-800 p-8 shadow-cardLg border border-ink-100 dark:border-ink-700 text-center">
